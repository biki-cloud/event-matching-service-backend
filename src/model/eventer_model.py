...
class EventerModel(BaseModel):
    id: Union[UUID, None] = Field(default=None, description="イベンターID",
                                  example="123e4567-e89b-12d3-a456-426614174000")
    info: Union[str, None] = Field(description="イベント主催者情報", example="祭りの説明")
    account_id: Union[UUID, None] = Field(default=None, description="イベンターが紐付いているユーザーID",
                                          example="123e4567-e89b-12d3-a456-426614174000")
...
def get_eventer_pynamo_model_from_eventer_model(eventer_model: EventerModel) -> EventerPynamoModel:
    return EventerPynamoModel(
        id=eventer_model.id,
        info=eventer_model.info,
        account_id=eventer_model.account_id
    )
