...
def get_account_pynamo_model_from_account_model(account_model: AccountModel) -> AccountPynamoModel:
    return AccountPynamoModel(
        id=account_model.id,
        email=account_model.email,
        password=account_model.password,
        role_type=account_model.role_type,
        role_id=account_model.role_id,
